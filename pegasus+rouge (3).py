...
Original file is located at
    https://colab.research.google.com/drive/1ysbD38n1bMIjiglqaXY0MIQzw2vYTSuY
"""
...
st.set_page_config(page_title='InNews: A Summarised News📰 Portal', page_icon="/content/sample_data/newspaper.ico")
...
def fetch_news_poster(poster_link):
    try:
        ...
        image = Image.open("/content/sample_data/no_image.jpg")
        st.image(image, use_column_width=True)
...
def display_news(list_of_news, news_quantity):
    ...
    for news in list_of_news:
        ...
        with st.expander(news.title.text):
            ...
            scores = rouge.get_scores(summary, news_data.text)
            st.write("Rouge-1 Score: {:.2f}".format(scores[0]['rouge-1']['f']*100))
            st.write("Rouge-2 Score: {:.2f}".format(scores[0]['rouge-2']['f']*100))
            st.write("Rouge-L Score: {:.2f}".format(scores[0]['rouge-l']['f']*100))
...
def run():
    ...
    image = Image.open("/content/sample_data/newspaper.png") 
